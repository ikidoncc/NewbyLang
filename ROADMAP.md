...
- [ ] **Namespaces**: Sistema para isolar símbolos (ex: `IO.print` vs `Log.print`).
- [ ] **Comando `import`**: Lógica de pré-processamento para carregar outros arquivos `.nb`.
- [ ] **Visibilidade (`pub`)**: Controle de quais funções e variáveis são expostas para fora de um arquivo.
